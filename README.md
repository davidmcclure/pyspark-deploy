...
- **`update.sh`** (TODO) - Update Docker containers on cluster nodes, restart Spark daemons to get the changes (~20s). Makes it easy to deploy updated code to a running cluster.
