...
- [**Docker**](https://www.docker.com/) is used to encapsulate the application environment, making it easy to develop locally and then deploy an identical environment to a cluster. Just extend the base [Dockerfile](docker/Dockerfile), and then point pyspark-deploy at your project's image.
